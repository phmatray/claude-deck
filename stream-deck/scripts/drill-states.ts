#!/usr/bin/env node
/** End-to-end "drill" for claude-deck state rendering.
 *
 ...
 *   - ../claude-code/hooks/notification.sh (NDJSON line format: ts, event, tool?, notifType?)
 */
...
async function runMulti(n: number) {
  ...
  const cwds = [
    process.cwd(),
    "/tmp/short",
    "/Users/me/dev/some-other-project",
    "/Users/me/dev/a-really-extremely-long-project-name-for-testing-the-ellipsis-overflow-behavior",
    "/var/tmp/another",
